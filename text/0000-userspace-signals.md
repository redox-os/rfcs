...
The kernel will set the corresponding pending bit, followed by reading the masked and pending bit simultaneously, the logical AND of which, is the set of deliverable signals.
